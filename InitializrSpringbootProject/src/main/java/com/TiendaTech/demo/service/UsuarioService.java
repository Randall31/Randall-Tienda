package com.TiendaTech.demo.service;

import com.TiendaTech.demo.domain.Rol;
import com.TiendaTech.demo.domain.Usuario;
import com.TiendaTech.demo.repository.RolRepository;
import com.TiendaTech.demo.repository.UsuarioRepository;
    ...
    public void save(Usuario usuario, MultipartFile imagenFile, boolean encriptaClave) {
        ...
        if (usuario.getIdUsuario() == null) {
            ...
            if (usuario.getPassword() == null || usuario.getPassword().isBlank()) {
                ...
                // CORRECCIÓN: Asignamos la contraseña existente tal cual, SIN volver a encriptarla.                
        ...
        if (imagenFile != null && !imagenFile.isEmpty()) { // Si no está vacío... pasaron una imagen...            
            try {
                ...
                // CORRECCIÓN: Lanzamos la excepción para que aborte la transacción si falla Firebase
                throw new RuntimeException("Error al subir la imagen del usuario a Firebase", e);
            }
        }
